   ...
   public class BuyerViewLogic
    {
        ...
        public static DataSet GetGetBillListData(string BuyerId,string connection)
        {
            DataSet ds = new DataSet();
            try
            {
                ...
                int clientID = Convert.ToInt32(HttpContext.Current.Session["ClientID"].ToString());
                SqlParameter[] sqlParam = {
                new SqlParameter("@customerid", SqlDbType.NVarChar) { Value = BuyerId },
