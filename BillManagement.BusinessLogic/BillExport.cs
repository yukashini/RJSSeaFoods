...
namespace BillManagement.BusinessLogic
{
    public class BillExport
    {
        ...
        public static string FetchExportScreenData(string DueFromDate, string DueToDate, int PaymentStatus, string connection)
        {
            ...
            try
            {
                ...
                SqlParameter[] sqlParam = {
                    new SqlParameter("@dueFromDate", SqlDbType.NVarChar) { Value = DueFromDate },
                    new SqlParameter("@dueToDate", SqlDbType.NVarChar) { Value = DueToDate },
                    new SqlParameter("@paymentStatus", SqlDbType.Int) { Value = PaymentStatus },
                    new SqlParameter("@clientID", SqlDbType.Int) { Value = ClientID }
               };
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetExportScreenData", sqlParam, connection);
        ...
        public static DataSet ExportScreenData(string DueFromDate, string DueToDate, int PaymentStatus, string connection)
        {
            DataSet ds = new DataSet();
            Common _objCommon = new Common();
            string Strresult = string.Empty;
            try
            {
                int ClientID = Convert.ToInt32(HttpContext.Current.Session["ClientID"].ToString());
                SqlParameter[] sqlParam = {
                    new SqlParameter("@SDueDate", SqlDbType.NVarChar) { Value = DueFromDate },
                    new SqlParameter("@EDueDate", SqlDbType.NVarChar) { Value = DueToDate },
                    new SqlParameter("@PmtSts", SqlDbType.Int) { Value = PaymentStatus },
                    new SqlParameter("@clientID", SqlDbType.Int) { Value = ClientID }
               };
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetBillData2Export", sqlParam, connection);
                int PostStatus = ApplicationUsers.InsertAuditlog("Export", "Bill List Exported", "Bills", connection);
                //if (ds.Tables.Count > 0)
                //{
                //    foreach (DataTable table in ds.Tables)
                //    {
        ...
        public static int DownloadBillData(DataTable billData, DataTable breakageData)
        {
            int postStatus = 1;
            try
            {
                ...
                if (billData.Rows.Count > 0)
                {
                    ...
                    BillExport bx = new BillExport();
                    bx.DownloadPrintedFile(sb);
                }
        ...
        public static int PrintBillData(string content)
        {
            string filePath = ConfigurationManager.AppSettings["ExportFilePath"].Trim();
            filePath = filePath+"Bill_Data.txt";
        ...
        public static string GeExportBillList(BillListFilter billFilter, string connection)
        {
            DataSet ds = new DataSet();
            Common _objCommon = new Common();
            string Strresult = string.Empty;
                ...
                SqlParameter[] sqlParam = {
                     ...
                     new SqlParameter("@orderby", SqlDbType.NVarChar) { Value = billFilter.OrderBy },
                      ...
                      new SqlParameter("@dueTo", SqlDbType.NVarChar) { Value = billFilter.DueDateTo },
                        new SqlParameter("@paymentStatus", SqlDbType.NVarChar) { Value = billFilter.PaymentStatus },
                };
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetPaginateExportBillList", sqlParam, connection);
