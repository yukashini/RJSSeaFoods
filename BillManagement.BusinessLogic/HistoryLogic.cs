...
namespace BillManagement.BusinessLogic
{
    ...
    {
        public static string GetInvoiceList(HistoryFilterfilter InvoiceList, string connection)
        {
            ...
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetHistoryList", sqlParam, connection);
        ...
        public static DataSet GetInvoiceData(string connection)
        {
            ...
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_HistoryDataList", sqlParam, connection);
            }
            catch (Exception ex)
            {
