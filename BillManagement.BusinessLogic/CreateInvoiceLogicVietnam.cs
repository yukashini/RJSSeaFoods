...
{
    public class CreateInvoiceLogicVietnam
    {
        public static string FetchCreateInvoiceVietnamMasterData(string connection)
        {
        ...
        public static int InsertInvoice(InvoiceObjectsVietnam objCustomer, string connection)
        {
            DataSet ds = new DataSet();
            Common _objCommon = new Common();
            string Strresult = string.Empty;
            ...
            try
            {
                ...
                SqlParameter[] sqlParam = {
                           ...
                           new SqlParameter("@buyer", SqlDbType.Int) { Value = objCustomer.Consignee},
                           new SqlParameter("@shipper", SqlDbType.Int) { Value = objCustomer.Shipper},
                           new SqlParameter("@Exporterdate", SqlDbType.VarChar) { Value = objCustomer.ExporterDate},
                           new SqlParameter("@invoice", SqlDbType.VarChar) { Value = objCustomer.Invoice},
                           new SqlParameter("@invoicedate", SqlDbType.VarChar) { Value = objCustomer.Invoicedate},
                           new SqlParameter("@buyersorder", SqlDbType.VarChar) { Value = objCustomer.BuyersOrder},
                           new SqlParameter("@Buyerdate", SqlDbType.VarChar) { Value = objCustomer.BuyerDate},
                           new SqlParameter("@vesselNo", SqlDbType.VarChar) { Value = objCustomer.VesselNo},
                           new SqlParameter("@precarriage", SqlDbType.VarChar) { Value = objCustomer.PreCarriage},
                           new SqlParameter("@placeofReceipt", SqlDbType.VarChar) { Value = objCustomer.PlaceofReceipt},
                           new SqlParameter("@Subtotal", SqlDbType.Decimal) { Value = objCustomer.Subtotal},
                           new SqlParameter("@Destination", SqlDbType.Int) { Value = objCustomer.Destination},
                           new SqlParameter("@Total", SqlDbType.Decimal) { Value = objCustomer.Total},
                           new SqlParameter("@container", SqlDbType.VarChar) { Value = objCustomer.Container},
                           new SqlParameter("@seal", SqlDbType.VarChar) { Value = objCustomer.Seal},
                           new SqlParameter("@portofLoading", SqlDbType.Int) { Value = objCustomer.PortofLoading},
                          new SqlParameter("@portofDischarge", SqlDbType.Int) { Value = objCustomer.PortofDischarge},
                          new SqlParameter("@terms", SqlDbType.Int) { Value = objCustomer.terms},
                          new SqlParameter("@payment", SqlDbType.Int) { Value = objCustomer.Paymentterms},
                          new SqlParameter("@carton", SqlDbType.VarChar) { Value = objCustomer.carton},
                          new SqlParameter("@Size", SqlDbType.VarChar) { Value = objCustomer.Size},
                          new SqlParameter("@declaration", SqlDbType.VarChar) { Value = objCustomer.declaration},

               };
                postStatus = SqlQueryExecutor.Custom_ExecuteWriteStoredProcedure("SP_InsertInvoicesVietnam", sqlParam, connection);
        ...
        public static int UpdateInvoice(CreateBillobj objCustomer, string connection)
        {
            ...
            try
            {
                ...
                postStatus = SqlQueryExecutor.Custom_ExecuteWriteStoredProcedure("SP_UpdateInvoiceVietnam", sqlParam, connection);
