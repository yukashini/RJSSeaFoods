...
{
    public class LabelMalaysia1
    {

        public static string GetInvoicelst(LabelMalaysiaInvoiceFilter List, string connection)
        {
            ...
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_MalaysiaLabel", sqlParam, connection);
        ...
        public static string FetchMalaysiaInfoScreenData(int LabelID, string connection)
        {
            DataSet ds = new DataSet();
            Common _objCommon = new Common();
            string Strresult = string.Empty;
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetLabelMalaysiaInfo", sqlParam, connection);
