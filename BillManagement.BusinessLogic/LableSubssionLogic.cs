...
{
   public class LableSubmissionLogics
    { 
        public static string GetInvoiceList(InvoiceVietnamFilterfilter InvoiceList, string connection)
        {
            ...
            try
            {
                ...
                SqlParameter[] sqlParam = {
                     ...
                     new SqlParameter("@Shipperid", SqlDbType.NVarChar) { Value = InvoiceList.Shipper },
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetInvoiceListVietnam ", sqlParam, connection);
        ...
        public static DataSet GetInvoiceData(string connection)
        {
            ...
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetInvoiceVietnamDataList", sqlParam, connection);
            }
            catch (Exception ex)
            {
        ...
        public static string GetInvoInVoicEmaildetails(int billId, string connection)
        {
            ...
            try
            {
                ...
                ds = SqlQueryExecutor.ExecuteStoredProcedure("SP_GetInvoiceVietnamEmaildetails", sqlParam, connection);
