...
{
    /// <summary>
    /// Summary description for CustomerDocuments
    /// </summary>
    public class ShipperDocuments : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Session["AccountID"] != null && context.Session["Role"] != null)
                {
                    ...
                    string billDirectory = Convert.ToString(ConfigurationManager.AppSettings["ShipperDocumentsDirectory"]);
