<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="ViewShipper360.aspx.cs" Inherits="BillManagement.ViewShipper360" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="isc-app-main-body-layout-container">
        <div class="isc-app-screen-content-s1">
                    ...
                    <div class="div-col-30per">
                        <div class="screen-row">
                            <div class="isc-page-header">
                                ...
                                <h2 style="line-height: 30px;">View Shipper</h2>
                                    ...
                                    <div class="div-col-50per">
                                        <div class="isc-page-header">
                                            <div class="div-col-60per">
                                                <h2 style="display: inline-block;"><span id="spn_shipper"></span></h2>
                            ...
                            <div class="screen-row mar-top-10">
                                <div class="isc-screen-nav-container-s1">
                                    <ul class="nav nav-tabs" style="position: relative;">
                                        <li class=""><a href="#Tab4" data-toggle="tab" id="Shipper-Contact-List">Contact</a> </li>
                                        <li class="" id="tab-details"><a href="#Tab5" data-toggle="tab">Details</a> </li>
                                        <li class=""><a href="#Tab8" data-toggle="tab" id="Shipper-Bank-List">Bank</a> </li>
                                        <li class=""><a href="#Tab6" data-toggle="tab" id="Shipper-tab">Documents</a> </li>
                                        <li class=""><a href="#Tab7" data-toggle="tab" id="shipper-Notes-List">Notes</a> </li>
                                    ...
                                    <div class="tab-content">                                       
                                        <div class="tab-pane fade in " id="Tab4">
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                ...
                                                <table class="isc-table-read-optimal isc-table-sorter-s1 mar-top-10" id="tbl-ShipperContact">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 25%;" class="header" sort-column-type="text" column-name="Name" data-sort-contact="Name">Name</th>
                                                            <th style="width: 40%;" class="header" sort-column-type="text" column-name="Email" data-sort-contact="Email">Email</th>
                                                            <th style="width: 25%;" class="header" sort-column-type="text" column-name="Phone" data-sort-contact="Phone">Phone Number</th>
                                            ...
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                <div class="screen-row">
                                                    <div class="cell-right pad-rig-5 " style="margin-top: 6px;">
                                                        ...
                                                        <a class="isc-theme-blue-btn" id="btn_Addbank">Add Bank</a>
                                                    </div>
                                                </div>
                                                 <div class="isc-tab-src-cont-res">
                                                <table class="isc-table-read-optimal isc-table-sorter-s1 mar-top-10" id="tbl-ShipperBank">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 20%;" class="header" sort-column-type="text" column-name="Name" data-sort-bank="Name">Bank Name</th>
                                                            <th style="width: 20%;" class="header" sort-column-type="text" column-name="Branch" data-sort-bank="Branch">Bank Branch</th>
                                                             <th style="width: 20%;" class="header" sort-column-type="text" column-name="Address" data-sort-bank="Address">Bank Address</th>
                                                            <th style="width: 15%;" class="header" sort-column-type="text" column-name="Account" data-sort-bank="Account">Bank A/C No.</th>
                                                            <th style="width: 20%;" class="header" sort-column-type="text" column-name="Code" data-sort-bank="Code">Bank Code</th>
                                                            <th style="width: 5%; cursor:default;">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="tbl-Bank-Body">
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="screen-row mar-top-10">
                                                    <div class="screen-row">
                                                        <div class="cell-right pad-rig-5 " style="margin-top: 6px;">
                                                            ...
                                                            <a id="btn-editShipper" class="isc-theme-blue-btn" href="#">Edit Shipper</a>
                                                        </div>
                                                    </div>

                                                    <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top: 0px;">Shipper Info : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                                <label class="mar-top-5">Shipper Name : </label>
                                                            </div>
                                                            <div class="div-col-50per">
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                         ...
                                                         <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                                <label class="mar-top-5">Shipper No: </label>
                                                            </div>
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_shipno"></label>
                                                            </div>
                                                        </div>
                                                  </div>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_gst"></label>
                                                            </div>
                                                        </div>
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_approvalno"></label>
                                                            </div>
                                                       </div>
                                                    </div>
                                                </div>
                                                <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b">Shipper Address : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                  ...
                                                  <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b">Process and Packed Address : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                                <label class="mar-top-5">Address: </label>
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PPaddress"></label>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PPcity"></label>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PPstate"></label>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PPcountry"></label>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PPzip"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="isc-pop-btn-cen-cell-s1">
                                <button type="button" data-toggle="modal" class="btn blue isc-btn-pop-action-s1" id="insert-Shipper-Contact" title="Add">
                                    Add</button>
                                <button type="button" class="btn blue isc-btn-pop-action-s1" id="Update-Shipper-Contact" style="display: none;">
                                    Update</button>
            ...
            <div class="modal fade isc-popup-detail-form-s1 in isc-new-pop-up" id="mp_add-Bank" tabindex="-1" role="basic" aria-hidden="false">
                <div class="modal-dialog" style="width: 650px;margin: 0 auto;margin-right: 0;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="screen-row">
                                <div class="cell-left">
                                    <h4 class="modal-title" id="div_Badd">Add Bank</h4>
                                </div>
                                <div class="cell-left" id="div_BUpdate" style="display:none">
                                    <h4 class="modal-title">Update Bank</h4>
                                </div>
                                <div class="cell-right">
                                    <a type="button" class="fa fa-times-circle isc-popup-close cell-right mar-top-10" data-dismiss="modal" aria-hidden="true" id="btn_Bclose" title="Close">
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="screen-row">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="screen-row">
                                                <div class="div-col-30per">
                                                    <label>Bank Name <sup class="isc-bill-mad-fld"><i class="fa fa-star" style="font-size: 8px !important;"></i></sup></label>
                                                </div>
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Name" id="Bank-Name" data-textbox="BankName" class="form-control alphabets-only">
                                                    <span class="validation-message" style="display: none; color: red" error-active="false" data-validation="firstName" id="Bank-Name-Validation">Bank Name should not be empty</span>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Code:" id="BankCode" class="form-control">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter A/c No." id="Acc-No" class="form-control">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter IFSC Code" id="IFSC-Code" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Branch" id="Bank-Branch" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Swift" id="Bank-Swift" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Routing No" id="Bank-Routing" class="form-control">
                                                </div>
                                            </div>
                                        </div>           
                                        <div class="form-group">
                                            <div class="screen-row">
                                                <div class="div-col-30per">
                                                    <label>Bank Wire No.</label>
                                                </div>
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Wire No" id="Bank-Wire" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Address" id="Bank-Address" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter City" id="Bank-City" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter State" id="Bank-State" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Country" id="Bank-Country" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Zip" id="Bank-Zip" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <div class="isc-pop-btn-cen-cell-s1">
                                <button type="button" data-toggle="modal" class="btn blue isc-btn-pop-action-s1" id="insert-Shipper-Bank" title="Add">
                                    Add</button>
                                <button type="button" class="btn blue isc-btn-pop-action-s1" id="Update-Shipper-Bank" style="display: none;">
                                    Update</button>
                                <button type="button" class="btn default isc-btn-pop-action-s2" id="btn_Bcancel" data-dismiss="modal" title="Cancel">
                                    Cancel</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
            ...
            <div class="modal fade isc-popup-detail-form-s1 in isc-new-pop-up" id="EditBank" tabindex="-1" role="basic" aria-hidden="false">
                <div class="modal-dialog" style="width: 650px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="screen-row">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Branch" class="form-control">
                                               </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Swift" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Routing Number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Wire Number"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="screen-row">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Bank Address" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    <div class="modal fade isc-popup-detail-form-s1 in" id="mp_bank_Delete" tabindex="-1" role="basic" aria-hidden="false" style="display: none;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        ...
                        <div class="cell-right">
                            <a><i class="fa fa-times-circle" style="color: #fff; cursor: pointer;" title="Close" delete-bank-cancel="true" id="btn_deleteclose" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                <div class="screen-row">
                   <div class="modal-body" style="min-height: 75px !important;">
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the bank?</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" data-delete-bank="0" id="btn-deleteBank-ok" data-dismiss="modal">
                            OK</button>
                        <button type="button" class="btn default isc-btn-pop-action-s2" delete-bank-cancel="true" data-dismiss="modal" id="close-delete">
                            Cancel</button>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <div class="modal fade isc-popup-detail-form-s1 in" id="mp_Contact_Delete" tabindex="-1" role="basic" aria-hidden="false" style="display: none;">
        <div class="modal-dialog" style="width: 400px;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" data-delete-OK="0" id="btn-deleteContact-ok" data-dismiss="modal">
                            OK</button>
    ...
    <script src="iscjsengine/PageScript/ViewShipper360.js"></script>
</asp:Content>
