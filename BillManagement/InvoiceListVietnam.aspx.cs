...
{
    public partial class InvoiceList1InvoiceListVietnam : System.Web.UI.Page
    {
        ...
        public static string GetInvoiceList(InvoiceVietnamFilterfilter Invoicelist)
        {
            DataSet ds = new DataSet();
            string data = string.Empty;
            try
            {
                data = InvoiceLogicVietnam.GetInvoiceList(Invoicelist, Login.Connection);
            }
            catch (Exception ex)
            {
        ...
        public static string GetInvoiceData()
        {
            ...
            try
            {
                ds = InvoiceLogicVietnam.GetInvoiceData(Login.Connection);
        ...
        public static string GetInvoicemaildetails(int BillId)
        {
            ...
            try
            {
                data = InvoiceLogicVietnam.GetInvoInVoicEmaildetails(BillId, Login.Connection);
