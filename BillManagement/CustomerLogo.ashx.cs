...
{
    /// <summary>
    /// Summary description for CustomerLogo
    /// </summary>
    public class CustomerLogo : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Session["AccountID"] != null && context.Session["Role"] != null)
                {
                    ...
                    string billDirectory = Convert.ToString(ConfigurationManager.AppSettings["CustomerLogoLocationDirectory"]);
