<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="ViewPurchase.aspx.cs" Inherits="BillManagement.ViewPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="div-col-30per">
                        <div class="screen-row">
                            <div class="isc-page-header">
                                ...
                                <h2 style="line-height: 30px;">View Purchase Details</h2>
                                    ...
                                    <div class="div-col-50per">
                                        <div class="isc-page-header">
                                            <div class="div-col-60per">
                                                <h2 style="display: inline-block;"><span id="spn_purchase"></span></h2>
                                ...
                                <div class="isc-screen-nav-container-s1">
                                    <ul class="nav nav-tabs" style="position: relative;">
                                        ...
                                        <li class="" id="tab-details"><a href="#Tab5" data-toggle="tab">Details</a> </li>
                                         <li class=""><a href="#Tab8" data-toggle="tab" id="Purchase-Ins">Inspection</a> </li>
                                        <li class=""><a href="#Tab4" data-toggle="tab" id="Purchase-Packing-List">Packing</a> </li>
                                        <li class=""><a href="#Tab9" data-toggle="tab" id="Purchase-Vessel-List">Vessel Scheduling</a> </li>
                                         <li class=""><a href="#Tab6" data-toggle="tab" id="Purchase-tab">Documents</a> </li>
                                        <li class=""><a href="#Tab7" data-toggle="tab" id="Purchase-Notes-List">Notes and Declaration</a> </li>
                                        ...
                                        <div class="tab-pane fade in " id="Tab6">
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                <div class="screen-row">
                                                    ...
                                                    <span class="isc-btn-inp-typ-file-s1 cell-right">Add Label
                                                ...
                                                <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top:0px;"> Label : </h5>
                                                <div id="div-Documents1-Body">
                                                </div>
                                            </div>
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                <div class="screen-row">
                                                    
                                                    <span class="isc-btn-inp-typ-file-s1 cell-right">Add Inspection 
                                                           <input type="file" name="filename" accept="image/gif, image/jpeg, image/png" style="width: 200px;" id="add-Documents" title="Add Document" />
                                                        </span>
                                                    
                                                </div>
                                                <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top:0px;">Inspection : </h5>
                                                <div id="div-Documents2-Body">
                                                </div>
                                            </div>
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                <div class="screen-row">
                                                    
                                                    <span class="isc-btn-inp-typ-file-s1 cell-right">Add LCDraft
                                                           <input type="file" name="filename" accept="image/gif, image/jpeg, image/png" style="width: 200px;" id="add-Documents" title="Add Document" />
                                                        </span>
                                                    
                                                </div>
                                                <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top:0px;"> LCDraft : </h5>
                                                <div id="div-Documents3-Body">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="isc-vnd-edit-foot-cont">
                                                    <div class="screen-row">
                                                        ...
                                                        <div class="div-col-5per">
                                                            <a id="add-Notes1" class="isc-vnd-msg-btn" style="cursor: pointer">Send</a>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="iscjsengine/PageScript/ViewPurchase.js"></script>
</asp:Content>
