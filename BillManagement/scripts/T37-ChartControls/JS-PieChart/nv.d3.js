...
nv.models.bulletChart = function() {
  ...
  var orient = 'top' // TODO top & bottom
    , reverse = true
...
nv.models.multiBarHorizontalChart = function() {
  ...
  var margin = {top: 30, right: 20, bottom: 50, left: 140}
    , width = null
    , height = null
    , color = nv.utils.defaultColor()
    , showControls = true
                ...
                group
                  .attr('transform', function(d) {
                       if (labelSunbeamLayout) {
                         d.outerRadius = arcRadius + 200; // Set Outer Coordinate
                         d.innerRadius = arcRadius + 70; // Set Inner Coordinate
                         ...
                         d.outerRadius = radius + 200; // Set Outer Coordinate
...
nv.models.pieChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var availableWidth = (width || parseInt(container.style('width')) || 600)
                             - margin.left - margin.right,
          availableHeight = (height || parseInt(container.style('height')) || 180)
                             - margin.top - margin.bottom;
...
nv.models.scatterChart = function() {
  ...
  var margin       = {top: 30, right: 40, bottom: 50, left: 75}
    , width        = null
    , height       = null
    , color        = nv.utils.defaultColor()
