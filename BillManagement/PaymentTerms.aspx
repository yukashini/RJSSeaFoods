<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="PaymentTerms.aspx.cs" Inherits="BillManagement.PaymentTerms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Payment Terms</h2>
                ...
                <div class="isc-app-screen-sec-container-s1 ">
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                        ...
                        <div class="cell-left  pad-lft-15">
                          <input type="text" class="form-control" placeholder="Enter Name" id="txt-Name"/>
                          </div>
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="tbl_PaymentTerms">
                                                <thead>
                                                    <tr>
   ...
   <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_paid" tabindex="-1" role="basic" aria-hidden="false" ">
        <div class="modal-dialog" style="width: 500px; ">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#2977cc">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 style="color:white" id="P-title" class="modal-title">Add Payment Terms </h4>
                        </div>
                        <div class="cell-right">
                                 ...
                                 <div class="screen-row mar-top-10">
                                    <div class="div-col-100per">
                                         <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Code" data-textbox="Payment_Code" id="Payment_Code" class="form-control <%--isc-exp-mang-txt-bx1--%>"/>
                                                            <span style="color:red;display:none;" class="validation-message" id="Payment_Code-Validation" data-validation="Payment_Code"> Code should not be empty</span>                                                      
                                                     </div>
                                     </div>
                                            </div>
                                        ...
                                        <div class="screen-row mar-top-10">
                                            ...
                                            <div class="div-col-100per">
                                                    <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Description" data-textbox="Payment_Name" id="Payment_Name" class="form-control <%--isc-exp-mang-txt-bx1--%>"/>
                                                            <span style="color:red;display:none;" class="validation-message" id="Payment_Name-Validation" data-validation="Payment_Name">Description should not be empty</span>                                                      
                                                     </div>
                                            </div>
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Save" id="btn-Save">
                            Save </button>
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Update" id="update-Payment" style="display:none">Update</button>
     ...
     <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_Payment_Delete" tabindex="-1" role="basic" aria-hidden="false" ">
                ...
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Port Of Payment Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Payment Terms?</h4>
    ...
    <script src="iscjsengine/PageScript/PaymentTerms.js"></script>
</asp:Content>
