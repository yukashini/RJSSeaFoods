<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="ViewBuyer360.aspx.cs" Inherits="BillManagement.ViewBuyer360" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="div-col-30per">
                        <div class="screen-row">
                            <div class="isc-page-header">
                                ...
                                <h2 style="line-height: 30px;">View Buyer</h2>
                                    ...
                                    <div class="div-col-50per">
                                        <div class="isc-page-header">
                                            <div class="div-col-60per">
                                                <h2 style="display: inline-block;"><span id="spn_
                                                    "></span></h2>
                            ...
                            <div class="screen-row mar-top-10">
                                <div class="isc-screen-nav-container-s1">
                                    <ul class="nav nav-tabs" style="position: relative;">
                                        <li class=""><a href="#Tab4" data-toggle="tab" id="buyer-Contact-List">Contact</a> </li>
                                        <li class="" id="tab-details"><a href="#Tab5" data-toggle="tab">Details</a> </li>
                                        <li class=""><a href="#Tab6" data-toggle="tab" id="Buyer-tab">Documents</a> </li>
                                        <li class=""><a href="#Tab7" data-toggle="tab" id="buyer-Notes-List">Notes</a> </li>
                                    ...
                                    <div class="tab-content">                                       
                                        <div class="tab-pane fade in " id="Tab4">
                                            <div class="isc-bill-inr-cont1 mar-top-10">
                                                ...
                                                <table class="isc-table-read-optimal isc-table-sorter-s1 mar-top-10" id="tbl-BuyerContact">
                                                    <thead>
                                                        <tr>
                                                ...
                                                <div class="screen-row mar-top-10">
                                                    <div class="screen-row">
                                                        <div class="cell-right pad-rig-5 " style="margin-top: 6px;">
                                                            ...
                                                            <a id="btn-editBuyer" class="isc-theme-blue-btn" href="#">Edit Buyer</a>
                                                        </div>
                                                    </div>

                                                    <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top: 0px;">Buyer Info : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_fax"></label>
                                                            </div>
                                                        </div>
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_liners"></label>
                                                            </div>
                                                       </div>
                                                    </div>
                                                </div>
                                                <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b">Buyer Address : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                  ...
                                                  <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b">Courier Address : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                                <label class="mar-top-5">Address: </label>
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_courieraddress"></label>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_couriercity"></label>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_courierstate"></label>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_couriercountry"></label>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_courierzip"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="isc-pop-btn-cen-cell-s1">
                                <button type="button" data-toggle="modal" class="btn blue isc-btn-pop-action-s1" id="insert-Buyer-Contact" title="Add">
                                    Add</button>
                                <button type="button" class="btn blue isc-btn-pop-action-s1" id="Update-Buyer-Contact" style="display: none;">
                                    Update</button>
    ...
    <script src="iscjsengine/PageScript/ViewBuyer360.js"></script>
</asp:Content>
