<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="PurchaseOrder.aspx.cs" Inherits="BillManagement.PurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-42per isc-set-fs-13">
                ...
                <div class="cell-right pad-rig-5 isc-sec-lvl-cust-dd-s1" style="margin-top: 12px; position: relative;">
                    ...
                    <ul class="isc-nested-list-dd-s2 isc-t-45" role="menu">
                        <li class=""><a title="Add Invoice" href="CreatePurchaseOrder.aspx">Add New</a>
                        </li>
  ...
  <li class="isc-feed-item">
    ...
    <script src="iscjsengine/PageScript/PurchaseOrder.js"></script>
