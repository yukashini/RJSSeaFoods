<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="PortofDischargeList.aspx.cs" Inherits="BillManagement.PortofDischargeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Port Of Discharge </h2>
            ...
            <div class="div-col-70per">
              ...
              <div class="cell-right">
                 ...
                 <div class="cell-right pad-rig-5 " style="margin-top:6px;">
                       ...
                       <a title="Add Project" href="#mp_paid" data-toggle="modal"  class="isc-theme-blue-btn" ><i class="fa fa-plus"></i></a>
            ...
            <div class="screen-row">
                <div class="isc-app-screen-sec-container-s1 ">
                    <div class="screen-row ">
                       ...
                       <div class="screen-row">
                            <table class="isc-table-read-optimal " id="Tbl_portofDischargelst">
                                                <thead>
                                                    <tr>                                                    
                                                       ...
                                                       <th style="width: 13.5%;" class="header">Country
                                                        </th>
   ...
   <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_paid" tabindex="-1" role="basic" aria-hidden="false" ">
        <div class="modal-dialog" style="width: 500px; ">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#2977cc">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 style="color:white" id="P-title" class="modal-title"> Port Of Discharge </h4>
                        </div>
                        <div class="cell-right">
                                 ...
                                 <div class="screen-row mar-top-10">
                                    <div class="div-col-100per">
                                         <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Code" data-textbox="DischargeCode" id="DischargeCode" class="form-control <%--isc-exp-mang-txt-bx1--%>">
                                                            <span style="color:red;display:none;" class="validation-message" id="DischargeCode-Validation" data-validation="DischargeCode"> Code should not be empty</span>                                                      
                                                     </div>
                                     </div>
                                            </div>
                                        ...
                                        <div class="screen-row mar-top-10">
                                            ...
                                            <div class="div-col-100per">
                                                    <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Description" data-textbox="DischargeName" id="DischargeName" class="form-control <%--isc-exp-mang-txt-bx1--%>">
                                                            <span style="color:red;display:none;" class="validation-message" id="DischargeName-Validation" data-validation="DischargeName">Description should not be empty</span>                                                      
                                                     </div>
                                            </div>
                                   ...
                                   <div class="screen-row mar-top-10">
                                            ...
                                            <div class="div-col-100per">
                                                    <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Country" data-textbox="DischargeCountry" id="DischargeCountry" class="form-control <%--isc-exp-mang-txt-bx1--%>">
                                                            <span style="color:red;display:none;" class="validation-message" id="DischargeCountry-Validation" data-validation="DischargeCountry">Country should not be empty</span>                                                      
                                                     </div>
                                            </div>
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Save" id="btn-Save" >
                            Save </button>
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Update" id="update-Discharge" style="display:none">Update</button>
     ...
     <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_Discharge_Delete" tabindex="-1" role="basic" aria-hidden="false" ">
                ...
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Port Of Discharge Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Port of Discharge?</h4>
    ...
    <script src="iscjsengine/PageScript/PortofDischargeList.js"></script>
</asp:Content>
