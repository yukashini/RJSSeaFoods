<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="CreateInvoiceAR.aspx.cs" Inherits="BillManagement.CreateInvoiceAR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="tab1-sec">
                            <div class="screen-row">
                                <div class="div-col-80per">
                                    ...
                                    <div class="screen-row">
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-25per">
                                                    <label class="mar-top-5">Customer :<sup class="isc-bill-mad-fld"></sup>  <i class="fa fa-plus-circle" href="#mp_paid3" data-toggle="modal" title="Quick Customer Add" style="cursor:pointer;"></i></label>
                                                </div>
                                                <div class="div-col-60per">
                                                    <select class="isc-select-dropdown select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" id="slt-customer">
                                        ...
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <select class="select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" id="slt-paymentterms">
                                    ...
                                    <div class="screen-row">
                                        ...
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" class="form-control" id="txt-duedate" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="screen-row">
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <select class="isc-select-dropdown select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" id="slt-salesrep">
                                        ...
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <input type="text" placeholder="Enter Reference Order" class="form-control" id="txt-referenceorder">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="screen-row" style="">
                                        ...
                                        <div class="div-col-50per" style="display: none">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <select id="slt-paymenttype" class="select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="screen-row" style="display: none" id="div-edit">
                                        <div class="div-col-50per">
                                            <div class="screen-row mar-top-10">
                                                ...
                                                <div class="div-col-60per">
                                                    <select class="select2 select2-hidden-accessible" id="slt-status" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="isc-bill-add">
                                                <div class="isc-var-s7 isc-mar-t1">
                                                    ...
                                                    <div class="isc-two-col">
                                                        <div class=" isc-lft-hdr">
                                                            <div class="isc-screen-row">
                                                                <div class="isc-var-s6 isc-wrap-item">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="isc-bill-add">
                                                <div class="isc-var-s7 isc-mar-t1">
                                                    ...
                                                    <div class="isc-two-col">
                                                        <div class=" isc-lft-hdr">
                                                            <div class="isc-screen-row">
                                                                <div class="isc-var-s6 isc-wrap-item mar-top-5  ">
                                                                </div>
                                                            </div>
                                        ...
                                        <table class="isc-table-read-optimal isc-tab-var-nofix isc-tab-var isc-table-sorter-s1">
                                            <tbody>
                                                <tr style="cursor: pointer;">
                                                    ...
                                                    <td style="width: 20%">
                                                        <h4><span id="spn-suptotal"></span></h4>
                                                    </td>
                                                ...
                                                <tr style="cursor: pointer;">
                                                    ...
                                                    <td style="width: 30%;">
                                                        <label class="isc-tck-tlt">Discount : </label>
                                                    </td>
                                                    <td style="width: 30%;">
                                                        <div class="isc-filter-details isc-cls-set-bdr-input isc-set-bdr-rght cell-left">

                                                            <input type="text" class="form-control isc-set-bdr-unset" id="txt-discount" name="planweek" placeholder="" aria-required="true">
                                                        </div>
                                                        <span class="isc-filter-details-span">
                                                            <select class="form-control" id="slt-distype">
                                                                <option>%</option>
                                                                <option>$</option>
                                                            </select></span>
                                                    ...
                                                    <td>
                                                        <h4><span id="spn-discount"></span></h4>
                                                    </td>
                                                ...
                                                <tr style="cursor: pointer;">
                                                    ...
                                                    <td style="width: 30%;">
                                                        <label class="isc-tck-tlt">Shipping Charges : </label>
                                                    </td>
                                                    <td style="width: 30%;">
                                                        <div class="isc-hor-details isc-hor-details2" style="width: 100%;">
                                                            <div class="isc-detail-name">
                                                                <input type="text" id="txt-shipping" class="form-control" id="task" name="task" placeholder="" aria-required="true" aria-invalid="true">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td style="width: 60%;"></td>
                                                    <td>
                                                        <h4><span id="spn-shpping"></span></h4>
                                                    </td>
                                                ...
                                                <tr style="cursor: pointer;">
                                                    ...
                                                    <td style="width: 30%;">
                                                        <label class="isc-tck-tlt">Tax(%): </label>
                                                    </td>
                                                    <td style="width: 30%;">
                                                        <div class="isc-hor-details isc-hor-details2" style="width: 100%;">
                                                            <div class="isc-detail-name">
                                                                <input type="text" id="txt-tax" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td style="width: 60%;"></td>
                                                    <td>
                                                        <h4><span id="spn-tax"></span></h4>
                                                    </td>
                                                ...
                                                <tr style="cursor: pointer;">
                                                    ...
                                                    <td style="width: 30%;">
                                                        <label class="isc-tck-tlt">Total($)</label>
                                                    </td>
                                                    <td style="width: 30%;"></td>
                                                    <td></td>
                                                    <td>
                                                        <h4><span id="span-total"></span></h4>
                                                    </td>
                                ...
                                <div class="isc-50">
                                    ...
                                    <div class="isc-screen-row isc-m-t-8">
                                        <div class="isc-hor-details">
                                            ...
                                            <div class="isc-detail-name">
                                                <textarea id="" name="w3review" rows="4" class="form-control" placeholder="Enter Terms and Conditions"></textarea>
                                            </div>
                                        </div>
                                    </div>
   ...
   <label> Payment Type </label>
                                ...
                                <div class="isc-details-sec">
                                    ...
                                    <div class="screen-row isc-pad-lft-65 mar-top-10">
                                        <div class="isc-33per">
                                            <div class="isc-hor-details">
                                                ...
                                                <div class="">
                                                    <input id="txt_dcity" type="text" class="form-control isc-w-200" id="planweek" name="planweek" placeholder=" Enter City" aria-required="true">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="isc-33per">
                                            <div class="isc-hor-details">
                                                ...
                                                <div class="isc-detail-name">
                                                    <input type="text" id="txt_dstate" class="form-control isc-w-200" id="planweek" name="planweek" placeholder=" Enter State" aria-required="true">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="isc-33per">
                                        <div class="isc-hor-details">
                                            ...
                                            <div class="isc-detail-name">
                                                <input type="text" id="txt_dzip" class="form-control isc-w-200" id="planweek" name="planweek" placeholder=" Enter ZIP" aria-required="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="isc-screen-row">
                                        <div id="editor">
                                            ...
                                            <p class="isc-set-clr-blue">
                                                <u>https://arcbill-qa.archarina.com/PaymentMethod.aspx?billID=26&&userBillId=4030	</u>
                                            </p>
                                            <p class="mar-top-15">
    ...
    <script src="iscjsengine/PageScript/CreateInvoiceAR.js"></script>
</asp:Content>
