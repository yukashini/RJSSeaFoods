<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="ApprovalList.aspx.cs" Inherits="BillManagement.ApprovalList" %>
        ...
        <div class="isc-app-screen-header-container" style="height: 46px;">
            ...
            <div class="div-col-50per">
                ...
                <div class="cell-right">
                    <div class="align-right  pad-rig-5 pad-lft-5" >

                        <a class="isc-theme-blue-btn filter-toggle-btn-cls" id="filter-toggle-btn" title="Filter" style="margin-left: 10px"><i class="fa fa-filter"></i></a>
                    </div>
                </div>
                <div class="cell-right">
                    <ul class="isc-sec-lvl-cust-dd-s1">
                        <li class=""><a title="More Options" type="button" class="isc-usr-sub-btn isc-t-11 isc-dd-drat-btn-s1 isc-sub-menu-list-s1 isc-bdr-rad-4 isc-top-unset-mb-res" data-toggle="dropdown" style="border-radius: 4px !important">Bulk Action<i class="fa fa-angle-down"></i></a>
                            <ul class="isc-nested-list-dd-s2 isc-t-4 isc-wid-120pix isc-aprl-blk" role="menu">
                                <li class=""><a title="Approve" id="btn-Approve" data-multi-submit="0">Approve</a></li>
                                <li class=""><a title="Reject" id="btn-Reject" data-multi-submit="1">Reject</a></li>
                ...
                <div class="isc-filter-container mar-top-10 isc-flt-hgt-mb-res" id="isc-filter-container" >
                    ...
                    <div class="screen-row">
                        <div class="div-col-80per">
                                ...
                                <div class="cell-left pad-lft-15 ">
                                    <input type="text" class="form-control iscdatpkrwdt iscdatepicker isc-frm-cont-mb-res" id="txt-DueRange" placeholder="Choose Date" />
                        ...
                        <div class="screen-row isc-mbl-mar-top-10">
                            ...
                            <div class="div-col-25per " style="cursor: pointer" data-kpi="50016">
                                <div class="isc-scr-sec-grp-container-s1 <%--kpi-active--%>">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        ...
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" id="un-Approved-Count" style="background-color:#F8AA56 !important;">0</a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <div class="screen-row ">
                                                        ...
                                                        <div class="cell-right">
                                                            <span class="isc-grp-sec-ent-spn" id="un-Approved-Week-Count" style="color:#F8AA56 !important;">0<i class="fa fa-arrow-up" style="margin-left: 5px;"></i></span>
                            ...
                            <div class="div-col-25per pad-lft-12 isc-mbl-mar-top-10" style="cursor: pointer" data-kpi="50015">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">Approved Bills <%--<span class="isc-usr-hmethr-kpi-spn">(54)</span>--%></h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="approved-Bill-Count">0
                                            </a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 id="approved-Bill-Amount" style="color:#14B191;">$0 </h5>
                                                    <div class="screen-row ">
                                                        <div class="cell-left">
                                                            <h4>Due This Week</h4>
                                                        </div>
                                                        <div class="cell-right">
                                                            <span class="isc-grp-sec-ent-spn isc-grp-sec-ent-spn-clr1" id="approved-Week-Count" style="color:#14B191 !important;">0<i class="fa fa-arrow-up" style="margin-left: 5px;"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="div-col-25per pad-lft-12 isc-mbl-mar-top-10" style="cursor: pointer" data-kpi="50036">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">Disputed Bills <%--<span class="isc-usr-hmethr-kpi-spn">(23)</span>--%></h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #ad1717 !important;" id="disputed-Bill-Count">0</a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 id="disputed-Amount" class="isc-kpi-clr6">$0 </h5>
                                                    <div class="screen-row ">
                                                        <div class="cell-left">
                                                            <h4>Due This Week</h4>
                                                        </div>
                                                        <div class="cell-right">
                                                            <span class="isc-grp-sec-ent-spn isc-grp-sec-ent-spn-clr4" id="disputed-Week-Count" style="color:#ad1717 !important">0<i class="fa fa-arrow-up" style="margin-left: 5px;"></i></span>
                        ...
                        <div id="exp-lst-view">
                            ...
                            <div class="isc-screen-nav-container-s1 mar-top-med">
                                <ul class="nav nav-tabs isc-tab-brd-cont" style="position: relative;" id="ul-Tabs">

                                    <li class="active" style="cursor: pointer" id="waiting-Approval-Tab"><a data-toggle="tab">Awaiting Approvals <span id="awaiting-Count">(0)</span></a> </li>
                                    <li class="" style="cursor: pointer" id="disputed-Approvals-Tab"><a data-toggle="tab">Disputed Bills  <span id="disputed-Count">(0)</span></a> </li>
                                    <li class="" style="cursor: pointer" id="all-Approvals-Tab"><a data-toggle="tab">All Bills  <span id="all-Approval-Count">(0)</span></a> </li>
                                    <%--  <li class=""><a href="#Tab4" data-toggle="tab">Vendor Credits (4)</a> </li>--%>
                                </ul>
                                <%--<a class="isc-theme-blue-btn isc-app-lst-sub-btn1"  style="background-color:#68bb55;right:0px;" >Approve </a>--%>
                                <%--<a class="isc-theme-blue-btn isc-app-lst-sub-btn" style="background-color: #d45b5b !important;" >Reject </a>--%>
                                        ...
                                        <table class="isc-table-read-optimal isc-table-sorter-s1 isc-ddp-hdn-lst" id="tbl-Bills">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%;" class="" title="Vendor" sort-column-type="text" column-name="VendorName" data-sort="VendorName">Vendor
                                                    </th>
                                                    <th style="width: 13%;" class="" title="Bill#" sort-column-type="text" column-name="InvoiceNumber" data-sort="InvoiceNumber">Bill#
                                                    </th>

                                                    <th style="width: 16%;" class="" title="Bill Description" sort-column-type="text" column-name="Description" data-sort="Description">Bill Description
                                                        
                                                    </th>

                                                    <th style="width: 10%;" class="" title="Bill Status" sort-column-type="text" column-name="StatusName" data-sort="StatusName">Bill Status
                                                    </th>
                                                    <th style="width: 10%;" class="" title="Payment Mode" sort-column-type="text" column-name="StatusName" data-sort="StatusName">Payment Mode
                                                    </th>

                                                    <%--<th style="width: 7%;"  title="Stage">Stage
                                                    </th>--%>
                                                    <th style="width: 7%;" class="" title="Due Date" sort-column-type="date" column-name="DueDate" data-sort="DueDate">Due Date
                                                    </th>
                                                    <th style="width: 11%;" class="" sort-column-type="number" title="Total Amount" column-name="Amount" data-sort="Amount">Total Amount 
                                                    </th>
                                                    <th style="width: 12%;" class="" sort-column-type="number" title="Approved Amount" column-name="ApprovedAmount" data-sort="ApprovedAmount">Approved Amount 
                                                    </th>
                                                    <th style="width: 11%;" class="" sort-column-type="number" column-name="Balance" title="Balance Amount" data-sort="Balance">Balance Amount
                                                    </th>
                                                    <th style="width: 6%; text-align: center;" title="Action" class="">Action
                                                    </th>
                                        ...
                                        <table class="isc-table-read-optimal isc-table-sorter-s1 isc-ddp-hdn-lst">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 13%;" class="header">Vendor
                                                    </th>
                                                    <th style="width: 10%;" class="header">Bill#
                                                    </th>

                                                    <th style="width: 15%;" class="header">Bill Description
                                                        
                                                    </th>

                                                    <th style="width: 10%;" class="header">Bill Status
                                                    </th>

                                                    <th style="width: 8%;">Stage
                                                    </th>
                                                    <th style="width: 7%;" class="header">Due Date
                                                    </th>
                                                    <th style="width: 8%;" class="header">Processed On
                                                    </th>
                                                    <th style="width: 7%;" class="header">Amount Due
                                                    </th>
                                                    <th style="width: 10%;" class="header">Approved Amount
                                                    </th>
                                                    <th style="width: 6%;" class="header">Balance
                                                    </th>
                                                    <th style="width: 6%; text-align: center;" class="header">Action
                                                    </th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <a class="isc-action-badge-td-s1 pad-lft-5 " title="Approve" href="ApprovalDetail.aspx"><i class="fa fa-check-circle-o isc-app-icon-clr" style="font-size: 16px;"></i></a>
                                                        <a class="isc-action-badge-td-s1 pad-lft-5 " title="Reject" href="ApprovalDetail.aspx"><i class="fa fa-times-circle-o isc-rej-icon-clr" style="font-size: 16px;"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 style="text-align: right;">$470</h5>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 style="text-align: right;">$120</h5>
                                                    </td>
                                                    <td style="text-align: center;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 style="text-align: right;">$650</h5>
                                                    </td>
                                                    <td>

                                                        <h5 style="text-align: right;">$450</h5>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="isc-td-inline-status-ch-s1">
                                                            <a class="isc-lbl-act-read-list-s1 isc-wrk-flw-sta-open-req" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">Approval Pending</a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="#" class="isc-wrk-flw-sta-upload">Pending Submission</a></li>
                                                                <li><a href="#" class="isc-wrk-flw-sta-open-req">Approval Pending</a></li>
                                                                <li><a href="#" class="" style="color: green;">Approved</a></li>
...
Invoice for the purchase of PO799</h5>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title" id="pop-up-title">Bill Submit</h4>
                        </div>
                        <div class="cell-right">
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" btn-submit-ok="1" id="btn-submit-ok" data-dismiss="modal">
                            OK</button>
                        <button type="button" class="btn default isc-btn-pop-action-s2" submit-cancel="true" id="close-submit">
                            Cancel</button>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <div class="modal fade isc-popup-detail-form-s1 in Mp_Relese" id="Mp_RejectBill" data-backdrop="static" style="display: none" role="basic" aria-hidden="false">
        <div class="modal-dialog" style="width: 765px;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 class="modal-title">Bill Reject</h4>
                        </div>
                        <div class="cell-right">
                            <a cancel-reject-pop="true" title="Close" style="cursor: pointer"><i class="fa fa-times-circle"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="screen-row ">
                            <div class="">
                                <div class="isc-pay-lbl-txt">
                                    <label class="mar-top-5">Rejection Reason <span style="color: red;">*</span> : </label>
                                </div>
                            </div>
                            <div class="">
                                <textarea placeholder="Enter Rejection Reason" id="txt-Reject-Reason" rows="4" maxlength="250" class="form-control" style="margin-top: 23px;"></textarea>
                ...
                <div class="modal-footer">
                     <div class="cell-right pad-lft-max">
                        <div class="isc-pop-btn-cen-cell-s1">
                            <button type="button" class="btn blue isc-btn-pop-action-s1" cancel-reject-pop="true" style="background-color: #fff !important;border:1px solid #efefef;color:#000 !important;">
                                Cancel</button>
                        </div>
                    </div>
                    <div class="cell-right ">
                        <div class="isc-pop-btn-cen-cell-s1">
                            <button type="button" class="btn blue isc-btn-pop-action-s1" btn-submit-ok="1">
                                Ok</button>
                        </div>
                    </div>
    ...
    <script src="iscjsengine/PageScript/ApprovalList.js"></script>
</asp:Content>
