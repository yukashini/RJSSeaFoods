<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="ViewLabelMalaysia.aspx.cs" Inherits="BillManagement.ViewLabelMalaysia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="div-col-30per">
                        <div class="screen-row">
                            <div class="isc-page-header">
                                ...
                                <h2 style="line-height: 30px;">View Malaysia</h2>
                           ...
                           <%-- <div class="isc-ven-edit-cont1">     
                                    ...
                                    <div class="div-col-50per">
                                        <div class="isc-page-header">
                                            <div class="div-col-60per">
                                                <h2 style="display: inline-block;"><span id="spn_buyer"></span></h2>
                                ...
                                <div class="screen-row mar-top-15">
                                    <div class="div-col-20per" style="padding-left: 65px;">
                                        ...
                                        <h4 class="isc-vnd-edt-acc"><a href="#"><i class="fa fa-envelope-o"></i> <span id="spn_product"></span></a></h4>
                                    </div>
                                    <div class="div-col-15per">
                                        <label>ProductionCode</label>
                                        <h4 class="isc-vnd-edt-acc"><a href="#"><i class="fa fa-phone"></i> <span id="spn_production"></span></a></h4>
                                    </div>
                                </div>
                            </div>--%>
                                                ...
                                                <div class="screen-row mar-top-10">
                                                    <div class="screen-row">
                                                        <div class="cell-right pad-rig-5 " style="margin-top: 6px;">
                                                            ...
                                                            <a id="btn-editMalaysia" class="isc-theme-blue-btn" href="#">Edit Label Malaysia</a>
                                                        </div>
                                                    </div>

                                                    <h5 class="isc-bill-trk-hdr-txt mar-top-30 isc-g-b" style="margin-top: 0px;">Label Info : </h5>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            <div class="div-col-30per">
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_product"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_approve"></label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_production"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_origin"></label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_size"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_weight"></label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_gross"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_net"></label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_PDate"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     <div class="screen-row mar-top-10">
                                                        <div class="div-col-50per">
                                                            ...
                                                            <div class="div-col-50per">
                                                                <label class="mar-top-5" id="lbl_BBDate"></label>
                                                            </div>
                                                        </div>
                                                     </div>
                                                </div>
    ...
    <script src="iscjsengine/PageScript/ViewLabelMalaysia.js"></script>
</asp:Content>
