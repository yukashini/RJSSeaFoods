<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="InvoiceListVietnam.aspx.cs" Inherits="BillManagement.InvoiceList1InvoiceListVietnam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-42per isc-set-fs-13">
                ...
                <div class="cell-right pad-rig-5 isc-sec-lvl-cust-dd-s1" style="margin-top: 12px; position: relative;">
                    ...
                    <ul class="isc-nested-list-dd-s2 isc-t-45" role="menu">
                        <li class=""><a title="Add Invoice" href="CreateInvoiceVietnam.aspx">Add Invoice</a>
                        </li>
                                ...
                                <div class="isc-temp-bdy-cont">
                                    <div class="screen-row">
                                        <div class="div-col-25per isc-primary-title ">
                                            <div class="isc-screen-row">
                                                <div class="isc-acc-box-inner-txt isc-mar-top">
                                                    <p class="isc-f-w-br">Shipper :</p>
                                                    <div class=" isc-lft-hdr">

                                                        <span id="lbl_Shipper"></span>
                                                    </div>
                                        ...
                                        <div class="div-col-25per isc-primary-title ">
                                            <div class="isc-screen-row">
                                                <div class="isc-acc-box-inner-txt isc-mar-top ">
                                                    <p class="isc-f-w-br">Consignee :</p>
                                                    <div class=" isc-lft-hdr">

                                                        <span id="lbl_Consignee"></span>
                                                    </div>
                                        ...
                                        <div class="div-col-25per isc-primary-title ">
                                            <div class="isc-screen-row">
                                                <div class="isc-acc-box-inner-txt isc-mar-top">
                                                    <p class="isc-f-w-br">Processed and Packed :</p>
                                                    <div class=" isc-lft-hdr">
                                    ...
                                    <div class="screen-row mar-top-50">
                                        <div class="isc-acc-box-inner-txt isc-mar-top">
                                            <p class="isc-f-w-br">Declaration : </p>
                                            <div class=" isc-lft-hdr">
  ...
  <li class="isc-feed-item">
    ...
    <script src="iscjsengine/PageScript/InvoiceListVietnam.js"></script>
