...
//Load And Events
{
    ...
    $(document).on('click', '[data-delete-Customer]', function () {
        ...
        if (parseInt(associatedCount) == 0 && parseInt(associatedProject) == 0) {
...
//Dom Manipulation
{
    ...
    var BindCustomers = function () {
        ...
        $('#tbl-Customers').DataTable({
            ...
            "ajax": {
                "url": "CustomersList.aspx/GetCustomersDataList",
                ...
                "dataSrc": function (json) {
                    ...
                    json.data = common.AUF(objData['CustomersList']);
            ...
            'aoColumns': [
                ...
                },
                {
                    ...
                    "mData": function (data, type, dataToSet) {
                        ...
                        html += '<a class="isc-action-badge-td-s1 pad-lft-5 btn_View" title="View" id="btn_View"  href="ViewCustomer.aspx?CustomerID=' + (data["CustomerID"] == null ? '' : data["CustomerID"]) + '"><i class="fa fa-eye"></i></a>';
