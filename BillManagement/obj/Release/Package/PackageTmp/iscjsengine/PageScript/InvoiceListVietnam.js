...

{
    var BindInvoiceList = function () {
        ...
        $('#tbl-invoice').DataTable({
            ...
            "ajax": {
                "url": "InvoiceListVietnam.aspx/GetInvoiceList",
...
//data manipulation
{
    ...
    var GetInvoiceData = function () {
        ...
        var tempList = {};
        $.when(RequestServer("InvoiceListVietnam.aspx/GetInvoiceData")).done(function (response) {
            tempList = $.parseJSON(response);
        });
        return tempList;
    }
...
//Click Event
{
    ...
    $(document).on('click', '[data-Editinvoice]', function () {
        ...
        //}
            ...
            window.location.href = "CreateInvoiceVietnam.aspx?Invoiceid=" + invoiceId + "";
        }
