<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="PortofLoadingList.aspx.cs" Inherits="BillManagement.PortofLoadingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Port Of Loading </h2>
                ...
                <div class="isc-app-screen-sec-container-s1 ">
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="Tbl_PortofLoadingList">
                                                <thead>
                                                    <tr>
   ...
   <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_paid" tabindex="-1" role="basic" aria-hidden="false" ">
        <div class="modal-dialog" style="width: 400px; position:center; ">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#2977cc">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 style="color:white" id="P-title" class="modal-title">Port of Loading </h4>
                        </div>
                        <div class="cell-right">
                                 ...
                                 <div class="screen-row mar-top-10">
                                    <div class="div-col-100per">
                                         <div class="div-col-50per">
                                          ...
                                          <div class="div-col-50per">
                                                 <input type="text" placeholder="Enter Code" data-textbox="LoadingCode" id="LoadingCode" class="form-control <%--isc-exp-mang-txt-bx1--%>">
                                                  <span style="color:red;display:none;" class="validation-message" id="LoadingCode-Validation" data-validation="LoadingCode"> Code should not be empty</span>                                                      
                                          </div>
                                     </div>
                                  </div>
                              </div>
                                        <div class="screen-row mar-top-10">                                        
                                            <div class="div-col-100per">
                                                    <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Description" data-textbox="LoadingName" id="LoadingName" class="form-control <%--isc-exp-mang-txt-bx1--%>">
                                                            <span style="color:red;display:none;" class="validation-message" id="LoadingName-Validation" data-validation="LoadingName">Description should not be empty</span>                                                      
                                                     </div>
                                            </div>
                                         </div>
                                     </div>
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Save" id="btn-Save">
                            Save </button>
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Update" id="update-Loading" style="display:none">Update</button>
     ...
     <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_Loading_Delete" tabindex="-1" role="basic" aria-hidden="false" ">
                ...
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Port Of loading Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Port of loading?</h4>
    ...
    <script src="iscjsengine/PageScript/PortofLoadingList.js"></script>
</asp:Content>
