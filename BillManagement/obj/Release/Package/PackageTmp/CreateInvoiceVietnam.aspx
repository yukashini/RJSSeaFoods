                    ...
                    <div class=" isc-pad-all">                     
                        <div class="tab1-sec">
                            ...
                            <div class="screen-row mar-top-10">
                             ...
                             <span style="margin-left: -67px;">Address Info	</span><br />
                         </h5>
                                    <br/>
                                    ...
                                    <div class="screen-row">
                                        <div class="div-col-50per">
                                            <div class="isc-bill-add">
                                              ...
                                              <input type="text"  id="BillingAdd" class="form-control1" readonly/>
                                        </div>
                                        ...
                                        <div class="div-col-50per">
                                         ...
                                         <div class="screen-row">
                                         <input type="text"  id="DeliveryAdd" class="form-control1" readonly/>
                                             </div><br />
                                    </div>
                                </div>
                                <div class="isc-40per" style="float: right;">
                                    <div class="isc-bill-cont " style=""><br />
