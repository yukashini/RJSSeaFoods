...
namespace BillManagement
{
    public partial class History1 : System.Web.UI.Page
    {
        ...
        public static string GetInvoiceList(HistoryFilterfilter Invoicelist)
        {
            DataSet ds = new DataSet();
            string data = string.Empty;
            try
            {
                data = HistoryLogic.GetInvoiceList(Invoicelist, Login.Connection);
            }
            catch (Exception ex)
            {
        ...
        public static string GetInvoiceData()
        {
            ...
            try
            {
                ds = HistoryLogic.GetInvoiceData(Login.Connection);
