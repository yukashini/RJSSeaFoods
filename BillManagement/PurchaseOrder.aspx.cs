...
namespace BillManagement
{
    public partial class PurchaseOrder : System.Web.UI.Page
    {
        ...
        public static string GetInvoiceList(InvoiceVietnamFilterfilter Invoicelist)
        {
            ...
            try
            {
                data = PurchaseOrderLogic.GetInvoiceList(Invoicelist, Login.Connection);
            }
            catch (Exception ex)
            {
        ...
        public static string GetInvoiceData()
        {
            ...
            try
            {
                ds = PurchaseOrderLogic.GetInvoiceData(Login.Connection);
        ...
        public static string GetInvoicemaildetails(int BillId)
        {
            ...
            try
            {
                data = PurchaseOrderLogic.GetInvoInVoicEmaildetails(BillId, Login.Connection);
        ...
        public static string GetTimelinelist(int BillId)
        {
            ...
            try
            {
                data = PurchaseOrderLogic.GetTimelinelist(BillId, Login.Connection);
