<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="DeliveryConditions.aspx.cs" Inherits="BillManagement.DeliveryConditions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Delivery Conditions</h2>
                ...
                <div class="isc-app-screen-sec-container-s1 ">
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="tbl_DeliveryConditions">
                                                <thead>
                                                    <tr>
   ...
   <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_paid" tabindex="-1" role="basic" aria-hidden="false" ">
        <div class="modal-dialog" style="width: 650px; ">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#2977cc">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 style="color:white" id="P-title" class="modal-title">Add Delivery Conditions</h4>
                        </div>
                        <div class="cell-right">
                                 ...
                                 <div class="screen-row mar-top-10">
                                    <div class="div-col-100per">
                                         <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Code" data-textbox="Delivery_Code" id="Delivery_Code" class="form-control <%--isc-exp-mang-txt-bx1--%>"/>
                                                            <span style="color:red;display:none;" class="validation-message" id="Delivery_Code-Validation" data-validation="Delivery_Code"> Code should not be empty</span>                                                      
                                                     </div>
                                     </div>
                                            </div>
                                        ...
                                        <div class="screen-row mar-top-10">
                                            ...
                                            <div class="div-col-100per">
                                                    <div class="div-col-50per">
                                                     ...
                                                     <div class="div-col-50per">
                                                            <input type="text" placeholder="Enter Description" data-textbox="Delivery_Name" id="Delivery_Name" class="form-control <%--isc-exp-mang-txt-bx1--%>"/>
                                                            <span style="color:red;display:none;" class="validation-message" id="Delivery_Name-Validation" data-validation="Delivery_Name">Description should not be empty</span>                                                      
                                                     </div>
                                            </div>
                ...
                <div class="modal-footer">
                    <div class="isc-pop-btn-cen-cell-s1">
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Save" id="btn-Save" data-dismiss="modal">
                            Save </button>
                        <button type="button" class="btn blue isc-btn-pop-action-s1" title="Update" id="update-Delivery" style="display:none">Update</button>
     ...
     <div class="modal fade isc-popup-detail-form-s1 Mp_Relese in" id="mp_Delivery_Delete" tabindex="-1" role="basic" aria-hidden="false" ">
                ...
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Delivery Condittions Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Delivery Conditions?</h4>
    ...
    <script src="iscjsengine/PageScript/DeliveryConditions.js"></script>
</asp:Content>
