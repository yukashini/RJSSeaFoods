<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PayNow.aspx.cs" Inherits="BillManagementV12.PayNow" %>
                ...
                <div class="isc-app-screen-sec-container-s1 ">
					...
					<h1 class="isc-tail-h1-p1 mar-top-30">Invoice</h1>
                                      ...
                                      <div class="div-col-14per">
                                       ...
                                       <div class="div-col-10per">
  <span class="isc-entity-sm-title">IN_001</span>
                                              <span class="isc-entity-sm-title">12/01/2021</span>
    ...
    <div class="isc-acc-box-inner-txt isc-mar-top ">
                                     ...
                                     <div class=" isc-lft-hdr">
                <p>Wllder Loop NE Rio Rancho,</p>
               <p>New Mexico, 87144</p>
    ...
    <div class="isc-acc-box-inner-txt isc-mar-top">
                                     ...
                                     <div class=" isc-lft-hdr">
           <h2 class="isc-thm-hme-kpi-t2  isc-color-p1">$7,678.00</h2>
                                      ...
                                      <table class="isc-t300-hrm-lst isc-table isc-table-row  isc-table-bordered mar-top-30">
                                                      <thead>
                                                          <tr>
                                                              ...
                                                              <th style="width:20%;text-align:right" title="Amount">Amonut</th>
                                                          </tr>
                                                      </thead>
                                                      <tbody>
                                                          <tr>
                        ...
                        <div class="isc-screen-row " style="margin-top: 20px;">
                            ...
                            <div class="isc-screen-nav-container-s1">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#Tab31" data-toggle="tab">Credit Card</a> </li>
                                    <li class=""><a href="#Tab32" data-toggle="tab">Bank Transfer</a> </li>
                                </ul>
                            </div>
   ...
   <label> Name On Card </label>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="Please Enter Plan Week" aria-required="true">
    </div>
                                          </div>
                                          </div>
                                 <div class="isc-50per">
   ...
   <label> CVV </label>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="123" aria-required="true">
    </div>
           </div>
                                                </div>
                                    </div>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="Please Enter Plan Week" aria-required="true">
                                ...
                                <ul class="isc-popup-entity isc-entity-btn" style="margin-top: 15px; width: 100%;">
                                        <li><a title="Add Project" type="button" class="isc-btn-wrap isc-btn-p1"> <i class="fa fa-shopping-bag" aria-hidden="true"></i> Pay $50</a> </li>
                                     

                                    </ul>
                                    </div>
                                <div class="screen-row">
                                <p class="isc-terms">By selecting Pay, I accept the Terms of service and have read and acknowledge the Policy Statement. I also allow to charge
$50.00 to my card on November 21, 2021 </p>
                                    </div>  
                                 </div>  <img src="images/visa2.png" class="isc-visa-img" />
                                </div>
   ...
   <label>Account Name</label>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="Please Enter Account Name" aria-required="true">
    </div>
                                          </div>
                                          </div>
                                 <div class="isc-50per">
   ...
   <label>Account Number</label>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="XXX XXXX XXX" aria-required="true">
    </div>
           </div>
   ...
   <label>Routing Number</label>
       ...
       <div class="isc-detail-name">
        <input type="text" class="required" id="planweek" name="planweek" placeholder="XXX XXX XXXX" aria-required="true">
    </div>
           </div>
