<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="InvoiceBuyer360.aspx.cs" Inherits="BillManagement.InvoiceBuyer360" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Buyer List</h2>
              ...
              <ul class="isc-sec-lvl-cust-dd-s1">
                                        <li class=""><a style="margin-top:5px;" title="More Options" type="button" class="isc-usr-sub-btn isc-t-11 isc-dd-drat-btn-s1 isc-sub-menu-list-s1 isc-bdr-rad-4 " data-toggle="dropdown">Action<i class="fa fa-angle-down"></i></a>
                                            <ul class="isc-nested-list-dd-s2 isc-t-45" role="menu">
                                                <li>
                                                     <a  title="Add Buyer" class="" href="AddBuyer.aspx">Add Buyer</a>
                                                </li>
   ...
   <div class="isc-app-screen-body-container" style="height: 285px;">
                ...
                <div class="isc-app-screen-sec-container-s1 ">
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                         ...
                         <div class="cell-left  pad-lft-15">
                          <input type="text" class="form-control" placeholder="Enter Liners" id="txt-liners"/>
                          </div>
                         
                        <div class="cell-left pad-lft-15 ">
                            <input type="text" class="form-control " placeholder="Enter Tax Id" id="txt-taxid"/>
                        </div>
         ...
         <div class="screen-row mar-bot-med">
                            <div class="div-col-15per ">
                               <div class="isc-scr-sec-grp-container-s1">
                                        <div class="isc-scr-sec-grp-hdr-container-s1">
                                            <div class="cell-left">
                                               <h2 class="isc-scr-sec-hdr-s1">TOTAL BUYERS</h2>
                                            </div>
                                            <div class="cell-right"><a class="isc-apr-hm-kpi-btn" id="tot-buyers"></a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="screen-row">
                                                <div class="isc-grp-sec-ent-cell-s1">
                                                    ...
                                                    <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                      ...
                                                      <h5 ><span id="Buyers-count"></span></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">VIETNAM BUYERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #ED5263;" id="VIT-Buyers"></a>
                                        </div>
                                        ...
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 ><span id="VIETNAM-Buyers"></span></h5>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">SINGAPORE BUYERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #F8AA56;" id="Sing_Buyers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 ><span id="Singapore_Buyers"></span></h5>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">UAE BUYERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="UAE-Buyers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 ><span id="UAEmirates-Buyers"></span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">MALAYSIA BUYERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="Mala-Buyers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 ><span id="Malaysia-Buyers"></span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">UNITED KINGDOM BUYERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="UK-Buyers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                                            <div class="isc-grp-sec-ent-cell-s1">
                                                ...
                                                <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                    ...
                                                    <h5 ><span id="UntKing-Buyers"></span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="tbl_Buyerlist">
                                                <thead>
                                                    <tr>
                                                        
                                                        <th style="width: 11%;" class="header">Buyer Name
                                                        </th>
                                                      
                                                        <th style="width: 23.5%;" class="header">Buyer Address
                                                        </th>
                                                         <th style="width: 5.5%;text-align:center;" class="header headerSortDown">Contact No.
                                                        </th>
                                                         <th style="width: 13.5%;text-align:center;" class="header">Courier Address
                                                        </th>
                                                         <th style="width: 15.5%;text-align:center;" class="header">Liners
                                                        </th>
        ...
        <div class="modal-dialog" style="width: 650px;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 class="modal-title">Buyer Import</h4>
                        </div>
                        <div class="cell-right">
            ...
            <!-- /.mokdmadal-dialog -->
                    ...
                    <div class="modal fade isc-popup-detail-form-s1 in" id="mp_Buyer_Delete" tabindex="-1" role="basic" aria-hidden="false" style="display: none;">
        <div class="modal-dialog" style="width:400px;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Buyer Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Buyer?</h4>
                                    </div>
                                </div>                            
                            </div>
                        </div>
    ...
    <script src="iscjsengine/InvoiceBuyer360.js"></script>
</asp:Content>
