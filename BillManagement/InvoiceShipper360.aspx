<%@ Page Title="" Language="C#" MasterPageFile="~/Application.Master" AutoEventWireup="true" CodeBehind="InvoiceShipper360.aspx.cs" Inherits="BillManagement.InvoiceShipper360" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="div-col-30per">
                <div class="screen-row">
                    <div class="isc-page-header">
                        ...
                        <h2 style="line-height: 30px;">Shipper List</h2>
              ...
              <ul class="isc-sec-lvl-cust-dd-s1">
                                        <li class=""><a style="margin-top:5px;" title="More Options" type="button" class="isc-usr-sub-btn isc-t-11 isc-dd-drat-btn-s1 isc-sub-menu-list-s1 isc-bdr-rad-4 " data-toggle="dropdown">Action<i class="fa fa-angle-down"></i></a>
                                            <ul class="isc-nested-list-dd-s2 isc-t-45" role="menu">
                                                <li>
                                                     <a  title="Add Buyer" class="" href="AddShipper.aspx">Add Shipper</a>
                                                </li>
   ...
   <div class="isc-app-screen-body-container" style="height: 285px;">
                    ...
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                           <div class="cell-left pad-lft-15 ">
                            <input type="text" class="form-control isc-frm-cont-mb-res" id="txt- " placeholder="Enter Shipper Name">

                        </div>
                          </div>
                            
                         <div class="cell-left  pad-lft-15">
                          <input type="text" class="form-control" placeholder="Enter Approval No." id="txt-appno">
                          </div>
                         
                        <div class="cell-left pad-lft-15 ">
                            <input type="text" class="form-control " placeholder="Enter PP Approval No." id="txt-PP">
                        </div>
         ...
         <div class="screen-row mar-bot-med">
                            <div class="div-col-15per ">
                               <div class="isc-scr-sec-grp-container-s1">
                                        <div class="isc-scr-sec-grp-hdr-container-s1">
                                            <div class="cell-left">
                                               <h2 class="isc-scr-sec-hdr-s1">TOTAL SHIPPERS</h2>
                                            </div>
                                            <div class="cell-right"><a class="isc-apr-hm-kpi-btn" id="tot-shippers"></a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="screen-row">
                                                <div class="isc-grp-sec-ent-cell-s1">
                                                    ...
                                                    <div class="isc-grp-sec-ent-rig-cell-s1 isc-grp-sec-ent-cen-cell-s1">
                                                      ...
                                                      <h5 ><span id="shippers-count"></span></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">ODISHA SHIPPERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #ED5263;" id="Odisha-shippers"></a>
                                        </div>
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">ANDHRA PRADESH SHIPPERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #F8AA56;" id="Andhra_shippers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">WEST BENGAL SHIPPERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="West-Shippers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">TAMIL NADU SHIPPERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="Tamil-Shippers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                            ...
                            <div class="div-col-17per pad-lft-12">
                                <div class="isc-scr-sec-grp-container-s1">
                                    <div class="isc-scr-sec-grp-hdr-container-s1">
                                        <div class="cell-left">
                                            <h2 class="isc-scr-sec-hdr-s1">GOA SHIPPERS</h2>
                                        </div>
                                        <div class="cell-right">
                                            <a class="isc-apr-hm-kpi-btn" style="background-color: #14B191;" id="Goa-Shippers"></a>
                                        </div>
                                    </div>
                                    <div class="isc-scr-sec-grp-bdy-container-s1 isc-pad-non">
                                        <div class="screen-row">
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="tbl_ShipperList">
                                                <thead>
                                                    <tr>
                                                        
                                                        <th style="width: 11%;" class="header">Shipper Name
                                                        </th>
                                                      
                                                        <th style="width: 23.5%;" class="header">Shipper Address
                                                        </th>
                                                         <th style="width: 5.5%;text-align:center;" class="header headerSortDown">Processed & Packed
                                                        </th>
                                                         <th style="width: 13.5%;text-align:center;" class="header">PP Address
                                                        </th>
                                                         <th style="width: 15.5%;text-align:center;" class="header">Aproval No.
                                                        </th>
        ...
        <div class="modal-dialog" style="width: 650px;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left">
                            <h4 class="modal-title">Shipper Import</h4>
                        </div>
                        <div class="cell-right">
            ...
            <!-- /.mokdmadal-dialog -->
                    ...
                    <div class="modal fade isc-popup-detail-form-s1 in" id="mp_Shipper_Delete" tabindex="-1" role="basic" aria-hidden="false" style="display: none;">
        <div class="modal-dialog" style="width:400px;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="screen-row">
                        <div class="cell-left float-left">
                            <h4 class="modal-title">Shipper Delete</h4>
                        </div>
                        <div class="cell-right">
                        ...
                        <div class="screen-row">
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="screen-row">
                                        <h4>Are you sure want to delete the Shipper?</h4>
    ...
    <script src="iscjsengine/InvoiceShipper360.js"></script>
</asp:Content>
