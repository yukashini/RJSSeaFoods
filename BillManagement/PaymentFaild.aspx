<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentFaild.aspx.cs" Inherits="BillManagement.PaymentFaild" %>
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0 15px;">
                                                                    <p style="text-align: left; border-bottom: 5px solid #f98d06; padding-bottom: 15px;">
                                                                        <img src="https://www.archarina.com/images/arc-logo-blue.png"  style="width: 150px;" />
                                                                        <span style="float: right; position: relative; top: 0px; font-size: 13px; text-align: right; line-height: 17px; color: #888686; font-family: Arial, Verdana, Helvetica, sans-serif; ">
                                                ...
                                                <tr>
                                                    <td valign="top" width="700" class="flexibleContainerCell" style="padding-top:0 ; padding-bottom: 10px;">
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0 15px;">
                                                                    <p style="text-align: center; font-size: 23px; margin-top:10px;  margin-bottom: 25px; color: #5f5f5f; line-height: 19px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        Payment Failed
                                                                    </p>
                                                                    ...
                                                                    <p style="text-align: justify; padding: 5px 50px; font-size: 15px; margin-bottom: 0px; margin-top: 20px; color: #888686; line-height: 23px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        Sorry, your payment of $<span id="spn_amount"> </span> had failed. The payment was declined.
                                                                        Please make sure to verify your billing information and try again?
                                                                    </p>
...
<tr align="center">
                                                                ...
                                                                <td  style="background-color: #f98d06;border:unset;text-align:center;width:100px;padding:10px;-moz-border-radius: 6px;border-radius:6px;">
                                                                   
                                                                <a style="font-weight: 500;text-align: center;cursor: pointer;white-space: nowrap;border-radius: 6px !important;padding: 14px;font-size: 15px;margin-top: 8px;margin-bottom: 14px;color: #fff;text-decoration:none" href="#" target=""> Update Billing Information </a>  
</tr>
</tbody>
</table>
</td>
...
<td>
                                                                    ...
                                                                    <p style="padding: 0 15px; text-align: left; font-size: 14px; margin-bottom: 5px; margin-top: 0px; color: #888686; line-height: 26px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        <span style="display: inline-block; "> </span><span>Invoice Description : <span id="spn_descripion"></span> <!--<span style="padding-left:20px;"></span>--></span>
                                                                    </p>
                                                                    <p style="padding: 0 15px; text-align: left; font-size: 14px; margin-bottom: 5px; margin-top: 0px; color: #888686; line-height: 26px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        <span style="display: inline-block; "> </span><span>Payable Amount : <span id="span_amount"></span> <!--<span style="padding-left:20px;"></span>--></span>
                                                                    </p>
                                                                    <p style="padding: 0 15px; text-align: left; font-size: 14px; margin-bottom: 5px; margin-top: 0px; color: #888686; line-height: 26px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        <span style="display: inline-block; "> </span><span>Due On : <span id="spn_invoicedate"></span> <!--<span style="padding-left:20px;"></span>--></span>
                                                                    </p>
                                                                    <p style="padding: 0 15px; text-align: left; font-size: 14px; margin-bottom: 5px; margin-top: 0px; color: #888686; line-height: 26px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        <span style="display: inline-block; "> </span><span>Invoice Status : Payment Failed <!--<span style="padding-left:20px;"></span>--></span>
                                                                    </p>
...
<table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer" style="margin: 5px 9px;">
...
<td style="width:30%;color:#888686;text-align:center; border-bottom: 1px solid #cccccc;font-size: 15px; border-top: 1px solid #cccccc; margin-bottom: 0px; ; line-height: 25px; font-family: Arial, Verdana, Helvetica, sans-serif;padding:7px;vertical-align:top">
Unit Price
</td>
    ...
    <tbody id="tbl-invoice">
                                                    ...
                                                    <td>
                                                                    ...
                                                                    <p style="padding: 0 15px; text-align: left; font-size: 14px; margin-bottom: 65px; margin-top: 0px; color: #888686; line-height: 26px; font-family: Arial, Verdana, Helvetica, sans-serif;">
                                                                        <span style="display: inline-block; width: 20%;"></span><span style="display: inline-block; width: 61%;"> </span><span style="margin-left:47px">Total : $<span id="span_total"></span> <!--<span style="padding-left:20px;"></span>--></span>
                                                                    </p>
                                                    </td>
                                                </tr>
                                                        </table>
