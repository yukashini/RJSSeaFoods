...
{
    public partial class LabelMalaysia : System.Web.UI.Page
    {
        ...
        public static string GetInvoicelst(LabelMalaysiaInvoiceFilter list)
        {
            DataSet ds = new DataSet();
            string data = string.Empty;
            try
            {
                data = LabelMalaysia1.GetInvoicelst(list, Login.Connection);
