...
{
    /// <summary>
    /// Summary description for EmployeeLogo
    /// </summary>
    public class EmployeeLogo : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Session["AccountID"] != null && context.Session["Role"] != null)
                {
                    ...
                    string billDirectory = Convert.ToString(ConfigurationManager.AppSettings["EmployeeLogoLocationDirectory"]);
