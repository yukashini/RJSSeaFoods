...
//    $('.isc-table-sorter').tablesorter();
//    $('.isc-table-sorter-s1').tablesorter();
//    $('.isc-table-sorter-s2').tablesorter();
//    $('.isc-table-sorter-s3').tablesorter();
//    $('.isc-table-sorter-s4').tablesorter();
//});
