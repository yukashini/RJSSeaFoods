...
{
    /// <summary>
    /// Summary description for BillPaidDocuments
    /// </summary>
    public class BillPaidDocuments : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Session["AccountID"] != null && context.Session["Role"] != null)
                {
                    ...
                    {
                        context.Response.Redirect("RJSLogin.aspx");
                    }
                    string billDirectory = Convert.ToString(ConfigurationManager.AppSettings["PaidBillLocationDirectory"]);
                ...
                {
                    context.Response.Redirect("RJSLogin.aspx?rst=true&&isSessionOut=1");
                }
            }
            catch (Exception ex)
            {
